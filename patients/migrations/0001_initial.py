...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('address', '0004_auto_20210622_1637'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', address.models.AddressField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='PCP+', to='address.address')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qualified_CPTs', models.ManyToManyField(blank=True, related_name='who_can_see_comment', to='patients.CPTcode')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='Payment_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booked_servces', models.ManyToManyField(blank=True, related_name='booked_servces', to='patients.Roster')),
                ('care_taker', models.ManyToManyField(blank=True, help_text='providers, doktors, neuroses..', related_name='Patient_Profile_created_care_taker', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='Patient_Profile_created_by', to=settings.AUTH_USER_MODEL)),
                ('ethnicity', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='patients.ethnicity')),
                ('insurance', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='patients.insurance')),
                ('native_langauge', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='patients.language')),
                ('other_langauge', models.ManyToManyField(blank=True, related_name='Profileother_langauge', to='patients.Language')),
                ('primary_care_physician', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='patients.primarycarephysician')),
                ('race', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='patients.race')),
                ('religion', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='patients.religion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ManyToManyField(blank=True, related_name='emergency_contact', to='patients.Patient')),
            ],
        ),
    ]
